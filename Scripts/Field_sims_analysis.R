...
### Script for the analysis of simulation outputs (field study simulations);
...
sim_set_name = 'run_Ruddle_field_Tue2015_weatherSce' # enter name of simulation set here (corresponds to "run_*.csv" file name)
study_name = "S15-01803" # enter corresponding study ID
...
ov = list('bees.emerged.yr', 'f.emerged.yr', 'm.emerged.yr', 'f.postemergent.today', # out vars 
...
odf_summarize<-odf %>% 
  ...
  summarize(avg.bees.nesting.today = mean(bees.nesting.today), 
            avg.f.postemergent.today = mean(f.postemergent.today),
...
field_NO<-read_csv(paste0("C:/SolBeePop/Field_study_data/",study_name,"_field_Tables/NestOccup_",study_name,"_field.csv"))
...
field_cellProd<-read_csv(paste0("C:/SolBeePop/Field_study_data/",study_name,"_field_Tables/CellProd_",study_name,"_field.csv"))
...
field_offspring<-read_csv(paste0("C:/SolBeePop/Field_study_data/",study_name,"_field_Tables/OffspringOverview_",study_name,"_field.csv"))
