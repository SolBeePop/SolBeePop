...
@#$#@#$#@
## Population model for pesticide risk assessment for solitary bees

## Model description

A description of the model is provided in a separate document, following the ODD protocol and TRACE documenation.
The input parameters (set on the interface), model procedures and state variables are described in the spreadsheet "SolBeePop_Procedures_Feb2022.xlsx".

## Input file - update!!!

The model requires the csv input file "input.Q.floral" which lists the relative quality of the floral resource used by all bees on a given day (366 rows: header and 1 row for each day of the year; first column lists the day of the year, each of hte following columns list the daily quality, the number of columns defines the number of years simulated. The floral quality can range between 0 (no floral resources available in the landscape) and 1 (resource patch is in close proximity to the nest site and provides optimal pollen and nectar resources). 
@#$#@#$#@
default
true
0
...
@#$#@#$#@
<experiments>
  <experiment name="S15_01804_Sce3_calib4_earlymat" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>doy</metric>
    <metric>DateREP</metric>
    <metric>count turtles</metric>
    <metric>bees.emerged.yr</metric>
    <metric>f.emerged.yr</metric>
    <metric>m.emerged.yr</metric>
    <metric>bees.nesting</metric>
    <metric>bees.nesting.today</metric>
    <metric>sum.cells.today</metric>
    <metric>sum.f.cells.today</metric>
    <metric>sum.m.cells.today</metric>
    <metric>sum.cells</metric>
    <metric>sum.f.cells</metric>
    <metric>sum.m.cells</metric>
    <metric>mean.cells.today</metric>
    <metric>mean.f.cells.today</metric>
    <metric>mean.m.cells.today</metric>
    <metric>mean.cells</metric>
    <metric>mean.f.cells</metric>
    <metric>mean.m.cells</metric>
    <enumeratedValueSet variable="Start.day">
      <value value="119"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="Species">
      <value value="&quot;O.bicornis&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="Initial.num.f">
      <value value="60"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="Initial.num.m">
      <value value="90"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="Initial.stage">
      <value value="&quot;cocoon&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="Initial.age">
      <value value="300"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="RndSeed">
      <value value="6"/>
      <value value="5467"/>
      <value value="88"/>
      <value value="930"/>
    ...
    <enumeratedValueSet variable="MultiYearInput">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="List.input.floral">
      <value value="&quot;NA&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="Num.repeat.yr">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="input.floral">
      <value value="&quot;Floral_S15_01804_Sce3_Jan2022.csv&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="stoch.crop.forag">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="day.emerge.f">
      <value value="123"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="var.emerge.f">
      <value value="3"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="day.emerge.m">
      <value value="122"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="var.emerge.m">
      <value value="2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="latest.emerge">
      <value value="155"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="dev.egg">
      <value value="8"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="dev.larva">
      <value value="32"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="dev.cocoon">
      <value value="68"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="t.maturation">
      <value value="6"/>
      <value value="7"/>
      <value value="8"/>
      <value value="9"/>
    ...
    <enumeratedValueSet variable="m.life">
      <value value="7"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="max.nesting.life">
      <value value="39"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="p.max.nesting.life">
      <value value="0.045"/>
      <value value="0.05"/>
      <value value="0.055"/>
      <value value="0.06"/>
    ...
    <enumeratedValueSet variable="max.f.ratio">
      <value value="0.59"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="max.cells">
      <value value="1"/>
      <value value="1.2"/>
      <value value="1.4"/>
      <value value="1.6"/>
    ...
    <enumeratedValueSet variable="max.survival.e.f">
      <value value="0.74"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="max.survival.e.m">
      <value value="0.74"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="emerged.survival">
      <value value="0.9"/>
      <value value="0.95"/>
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="a.cell.age">
      <value value="-0.006"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="a.sex.age">
      <value value="-0.0406"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="a.size.age">
      <value value="-0.003"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="a.cell.resource">
      <value value="0.94"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="a.sex.resource">
      <value value="0.42"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="a.size.resource">
      <value value="0.114"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="Osmia_optimal_noDD_Oct2022" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>doy</metric>
    <metric>DateREP</metric>
    ...
    <enumeratedValueSet variable="input.floral">
      <value value="&quot;Floral_generic_optimal_control_28Oct2022.csv&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="stoch.crop.forag">
      <value value="false"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="DD.thresh.s">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="DD.max.cells.s">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="DD.funct">
      <value value="&quot;linear&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="DD.log.slope">
      <value value="0"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="Megachile_default_sceA_May2022" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>doy</metric>
    <metric>DateREP</metric>
    ...
    <enumeratedValueSet variable="input.floral">
      <value value="&quot;Floral_generic_Osmia_A_17Feb2022.csv&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="stoch.crop.forag">
      <value value="false"/>
    </enumeratedValueSet>
  ...
  <experiment name="Nomia_default_sceA_May2022" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>doy</metric>
    <metric>DateREP</metric>
  ...
  <experiment name="Eucera_default_sceA_May2022" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>doy</metric>
    <metric>DateREP</metric>
  ...
  <experiment name="S15_01804_Sce3_calib4_latemat" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>doy</metric>
    <metric>DateREP</metric>
  ...
  <experiment name="S15_01803_Sce3_calib4_latemat" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>doy</metric>
    <metric>DateREP</metric>
    ...
    <enumeratedValueSet variable="input.floral">
      <value value="&quot;Floral_S15_01803_Sce3_Jan2022.csv&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="stoch.crop.forag">
      <value value="false"/>
    </enumeratedValueSet>
  ...
  <experiment name="S15_01803_Sce3_calib4_earlymat" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>doy</metric>
    <metric>DateREP</metric>
  ...
  <experiment name="S15_01802_Sce3_earlymat_valid_set1" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>doy</metric>
    <metric>DateREP</metric>
    ...
    <enumeratedValueSet variable="input.floral">
      <value value="&quot;Floral_S15_01802_Sce3_Jan2022.csv&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="stoch.crop.forag">
      <value value="false"/>
    </enumeratedValueSet>
  ...
  <experiment name="S15_01802_Sce3_latemat_valid_set1" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>doy</metric>
    <metric>DateREP</metric>
  ...
  <experiment name="S15_01802_Sce3_earlymat_valid_set2" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>doy</metric>
    <metric>DateREP</metric>
  ...
  <experiment name="S15_01802_Sce3_latemat_valid_set2" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>doy</metric>
    <metric>DateREP</metric>
  ...
  <experiment name="S15_01802_Sce3_earlymat_valid_set3" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>doy</metric>
    <metric>DateREP</metric>
  ...
  <experiment name="S15_01802_Sce3_latemat_valid_set3" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>doy</metric>
    <metric>DateREP</metric>
  ...
  <experiment name="S15_01802_Sce3_earlymat_valid_set4" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>doy</metric>
    <metric>DateREP</metric>
  ...
  <experiment name="S15_01802_Sce3_latemat_valid_set4" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>doy</metric>
    <metric>DateREP</metric>
  ...
  <experiment name="Osmia_optimal_wDD" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>doy</metric>
    <metric>DateREP</metric>
