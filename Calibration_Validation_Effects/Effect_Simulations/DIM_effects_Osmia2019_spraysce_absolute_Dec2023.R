...
## Note: this script does not calculate GOFM!
## Offspring sex ratio by date NOT calculated or plotted
## Project: SolBeePop_ecotox
## Author: Amelie Schmolke (edited/extended script from CR)
...
sim_set_name_eff1 = '1310_2019_SD_med'
sim_set_name_eff2 = '1310_2019_SD_med_75p'
sim_set_name_eff3 = '1310_2019_SD_med_50p'
sim_set_name_eff4 = '1310_2019_SD_med_25p'
sim_set_name_eff5 = '1310_2019_SD_med_0p'
folder_contr = 'Control_Calib_Valid/' # outputs from control simulations
sim_set_name_contr = '1310'

# specifications of study data
folder_data = 'C:/SolBeePop_ecotox/Osmia_semi_field_data/'
study = 'Eurofins_Study1_2019'
study_year = 2019
...
plot_nest2<-ggplot()+
  ...
  geom_vline(xintercept = odf_c_avg$date_corr[12]+0.5, linewidth = 0.75, linetype = "dotted", color = "black")+ # for 2019
...
plot_brood2<-ggplot()+
  ...
  geom_line(data=odf_c_avg, aes(x= date_corr, y=max.sum.cells), color ="gray", linewidth=0.75)+
